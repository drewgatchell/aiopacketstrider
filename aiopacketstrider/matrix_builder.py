...
async def construct_window_matrix(pcap, matrix, stream, window, stride, meta_size, reverse_init_start, results):
    ...
    while datum < (len(matrix) - splay) \
        ...
        predict_exfiltration = await loop.run_in_executor(None, predict_exfil, new_window_row, meta_size,
                                                                          reverse_init_start)
        predict_infiltration = await loop.run_in_executor(None, predict_infil, new_window_row, meta_size,
                                                                          reverse_init_start)
